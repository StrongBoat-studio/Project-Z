...
public class Movement1 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        List<MovementState> currentStates = GetMovementStates2();
    ...
    private void OnCollisionStay2D(Collision2D collision)
    {
        ...
        if (!GetMovementStates2().Contains(MovementState.Jumping)) return;
    ...
    public List<MovementState> GetMovementStates2()
    {
